...
const EventOverview = () => {
  ...
  const gdgLocationText = "GDG on Campus Florida International University"
  const gdgLocationUrl = "https://gdg.community.dev/gdg-on-campus-florida-international-university/"
        ...
        <div className="flex flex-col gap-4 px-4">
          ...
          <div className="my-4">
            <ul className="flex justify-baseline items-center gap-3">
              {/* Discord */}
              <a 
                href="https://hacksatfiudiscord.vercel.app/" 
                className="border border-black rounded-full p-2 transition-transform duration-300 hover:scale-110"
              >
                <Image src="/discord.svg" alt="discord" width={18} height={18} />
              </a>
              {/* Instagram */}
              <a 
                href="https://www.linkedin.com/company/code-crunch-club" 
                className="border border-black rounded-full p-2 transition-transform duration-300 hover:scale-110"
              >
              ...
              <a 
                href="https://www.linkedin.com/company/code-crunch-club" 
                className="border border-black rounded-full p-[9px] transition-transform duration-300 hover:scale-110"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-gray-900 cursor-pointer">
              ...
              {/* YouTube */}
              <a 
                href="https://www.youtube.com/@CODECRUNCH-CS-FIU-EDU" 
                className="border border-black rounded-full text-gray-900 p-[8px] transition-transform duration-300 hover:scale-110"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="cursor-pointer">
              ...
              {/* Email */}
              <a 
                href="mailto:codecrunch@fiu.edu" 
                className="border border-black rounded-full p-[9px] transition-transform duration-300 hover:scale-110"
              >
